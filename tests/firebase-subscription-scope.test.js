...
assert.match(app,/const APP_VERSION="6\.149\.7"/);
assert.match(index,/Ver6\.149\.7/);
assert.match(index,/charge-core\.js\?v=6\.149\.7[\s\S]*app\.js\?v=6\.149\.7/);
assert.match(sw,/genesis-pos-v6\.149\.7-auth/);
assert.match(sw,/charge-core\.js\?v=6\.149\.7/);
